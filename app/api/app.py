...
try:
    from app.api.routes.active_context_selection import (
        router as active_context_selection_router,
    )
except ImportError:
...
try:
    from app.api.routes.heimdal_capture import router as heimdal_capture_router
except ImportError:
    heimdal_capture_router = None

try:
    from app.api.routes.heimdal_meeting import router as heimdal_meeting_router
except ImportError:
    heimdal_meeting_router = None
...
def _create_app() -> FastAPI:
    ...
    if heimdal_capture_router is not None:
        application.include_router(heimdal_capture_router)
    if heimdal_meeting_router is not None:
        application.include_router(heimdal_meeting_router)
