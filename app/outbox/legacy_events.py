...
def emit_index_object_embedded_with_vector(event: Dict[str, Any]) -> None:
    """LEGACY: emits index.object.embedded with an embedding vector.

    Kept only for historical replay/debugging; do not use for new code.
    New outbox records must not carry embedding vectors.
    """
