...
The note's ``agent_maintained``/``read_only``/``authority_role: derived`` frontmatter
keeps ingest uuid healing from rewriting it, so the composer stays its only writer (#5656).
"""
