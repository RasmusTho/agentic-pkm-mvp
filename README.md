...
- Promotion, export, and backfill flows documented in [`docs/architecture/obsidian_integration.md`](docs/architecture/obsidian_integration.md)

Status (v4.3)
- See [`docs/ROADMAP.md`](docs/ROADMAP.md) for the up-to-date checklist, near-term focus, and future ideas.

Docs
- docs/ARCHITECTURE.md
- docs/architecture/obsidian_integration.md
