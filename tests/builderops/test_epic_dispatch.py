...
def test_owner_wrappers_and_raw_mutations_are_separated() -> None:
    ...
    shell_push = {
        ...
        "item": {
            "type": "command_execution",
            "command": "/bin/zsh -lc 'git -C \"$worktree\" push origin HEAD'",
        },
    }
    shell_close = {
        "type": "item.started",
    ...
    raw_api_short_body = {
        ...
        "item": {
            "type": "command_execution",
            "command": "gh api repos/RasmusTho/agentic-pkm-mvp/releases -ftag_name=v1",
        },
    }
    raw_api_equals_method = {
        "type": "item.started",
        "item": {
            "type": "command_execution",
    ...
    raw_api_global_repo = {
        ...
        "item": {
            "type": "command_execution",
            "command": "gh --repo RasmusTho/agentic-pkm-mvp api git/refs -X POST",
        },
    }
    read_api_attached_jq = {
        "type": "item.started",
        "item": {
            "type": "command_execution",
            "command": "gh api repos/RasmusTho/agentic-pkm-mvp/releases -q.foo",
        },
    }
    read_api_attached_header = {
        "type": "item.started",
        "item": {
            "type": "command_execution",
            "command": "gh api repos/RasmusTho/agentic-pkm-mvp/releases -Hfoo:bar",
        },
    }
    owner_wrapper = {
        "type": "item.started",
    ...
    assert _raw_mutation_command(raw_api_global_repo) is True
    assert _raw_mutation_command(read_api_attached_jq) is False
    assert _raw_mutation_command(read_api_attached_header) is False
