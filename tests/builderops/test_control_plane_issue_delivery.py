...
def _manifest(*, operation_key: str = "operation-5550") -> dict[str, object]:
    ...
    artifacts = [
        ...
        {"path": "app/builderops/publication.py", "sha256": "1" * 64},
        {"path": "app/builderops/closure.py", "sha256": "1" * 64},
        {"path": "scripts/closure.py", "sha256": "1" * 64},
        {"path": "scripts/issue_pickup_claim.sh", "sha256": "1" * 64},
        {"path": "scripts/publication.py", "sha256": "1" * 64},
