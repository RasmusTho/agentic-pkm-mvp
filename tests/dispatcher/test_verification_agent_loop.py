...
def test_per_mechanism_two_plus_two_budget_and_independent_rereview(tmp_path) -> None:
    ...
    loop.repair(finding_id="F1", failure_domain="review_code_correctness", mechanism_id="parser", session_id="fix-1", capability="terra", reasoning_effort="high", context=context, outcome="fixed")
    with pytest.raises(ValueError):
        loop.review(session_id="fix-1", capability="terra", reasoning_effort="high", context=context, outcome="clean")
    loop.review(finding_id="F1", failure_domain="review_code_correctness", mechanism_id="parser", session_id="review-1", capability="terra", reasoning_effort="high", context=context, outcome="blocking")
    loop.repair(finding_id="F2", failure_domain="review_code_correctness", mechanism_id="parser", session_id="fix-2", capability="terra", reasoning_effort="high", context=context, outcome="fixed")
    with pytest.raises(ValueError):
        loop.repair(finding_id="F3", failure_domain="review_code_correctness", mechanism_id="parser", session_id="fix-3", capability="terra", reasoning_effort="high", context=context, outcome="fixed")
    loop.review(finding_id="F2", failure_domain="review_code_correctness", mechanism_id="parser", session_id="review-2", capability="terra", reasoning_effort="high", context=context, outcome="blocking")
    loop.repair(finding_id="F3", failure_domain="review_code_correctness", mechanism_id="parser", session_id="fix-3", capability="sol", reasoning_effort="xhigh", context=context, outcome="fixed", strongest=True)
    loop.review(finding_id="F3", failure_domain="review_code_correctness", mechanism_id="parser", session_id="review-3", capability="sol", reasoning_effort="xhigh", context=context, outcome="blocking")
    loop.repair(finding_id="F4", failure_domain="review_code_correctness", mechanism_id="parser", session_id="fix-4", capability="sol", reasoning_effort="xhigh", context=context, outcome="fixed", strongest=True)
    with pytest.raises(ValueError):
        loop.repair(finding_id="F5", failure_domain="review_code_correctness", mechanism_id="parser", session_id="fix-5", capability="sol", reasoning_effort="xhigh", context=context, outcome="fixed", strongest=True)
