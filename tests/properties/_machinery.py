...
REGISTERED_MIRRORS: dict[tuple[str, int], str] = {
    ...
    ("app/watcher/vault_watcher.py", 358): (
...
WRITE_FRONTMATTER_SITE_CLASSIFICATION: dict[tuple[str, int], str] = {
    ...
    ("app/instance/vault_registry.py", 2948): (
        ...
        "Line drifted 1373 -> 1394 -> 1403 -> 1953 -> 2266 -> 2330 -> 2357 -> 2496 -> 2503 -> 2745 -> 2838 -> 2893 -> 2926 -> 2930 -> 2935 -> 2948 "
        "(site unchanged); #5432 adds the transaction-refusal lock option. Re-pinned after directly related SETTINGS-05A (#4967) inserted "
