...
WRITE_FRONTMATTER_SITE_CLASSIFICATION: dict[tuple[str, int], str] = {
    ...
    ("app/instance/vault_registry.py", 2330): (
        ...
        "Line drifted 1373 -> 1394 -> 1403 -> 1953 -> 2266 -> 2330 (site "
...
WRITE_NOTE_RELATIVE_SITE_CLASSIFICATION: dict[tuple[str, str, int], str] = {
    ...
    ("app/heimdal/time_spend.py", "write_time_spend_note", 1): (
        ...
        "expected-version compare-and-swap (the port guard is the only gate, "
        "and WritesBlockedError from it still converts to the loud, "
