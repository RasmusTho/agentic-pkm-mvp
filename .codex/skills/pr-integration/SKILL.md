---
name: pr-integration
description: "Prepare an implementation PR for verification by resolving merge conflicts, enforcing PR contract metadata, and ensuring CI is green on the latest head."
---
