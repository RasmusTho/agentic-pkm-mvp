...
Issue labels/state and PR state are authoritative. Project projection is not part of integration;
when explicit projection repair is needed, route it through `issue-maintenance-change-control` and
use `.codex/skills/_shared/LIFECYCLE_TRUTH_MATRIX.md`.
