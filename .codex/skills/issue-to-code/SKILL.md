...
- Before an expensive local full suite for auth/security/data/migration/concurrency/external-API,
  ...
  static checks precede this review; the full suite follows it. This cheap design/correctness gate
  does not replace the final current-SHA CI or review gate.
