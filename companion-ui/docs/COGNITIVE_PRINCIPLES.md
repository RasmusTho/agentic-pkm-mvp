...
## First principles
1. Vault canonicality: durable semantic truth lives in vault-readable markdown/frontmatter.
2. Human centrality: the human owns intent, decisions, and commitment transitions.
...
Design and implementation should optimize for cognitive coherence, not throughput theater.
