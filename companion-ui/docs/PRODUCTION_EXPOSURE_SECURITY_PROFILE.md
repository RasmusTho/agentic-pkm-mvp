...
page or asset route. The merged #4836 shell consumes this boundary unchanged: its Companion-owned
...
style, and connect only. The shell is delivered in the repository, but this does not prove
production deployment or owner acceptance; #4748 and #4749 remain the applicable later gates.
