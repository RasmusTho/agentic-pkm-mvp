...
| v4.5B | Unified ingestion polish + hook readiness | Hook scaffolds, rerank stub, diarization adapter skeleton | Integrate rerank, diarization, RelationIndex fitness | Enable hooks in staging with metrics | In development, needs acceptance tests |
