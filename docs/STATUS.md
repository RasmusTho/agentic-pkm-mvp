...
cognition scaffold exists for planning/decomposition through the shared `ReasoningFacade`. In
...
Panel/Chat integration remain v6/non-baseline surfaces governed by
