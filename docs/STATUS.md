...
Last verified against: docs/ARCHITECTURE.md, docs/ROADMAP.md, docs/DOCS_INDEX.md, docs/OPERATIONS.md, docs/HUMAN-FLOWS.md, docs/PANEL_AGENT.md, docs/COMPANION_UI_PRODUCT_SPEC.md, docs/CANVAS_CHAT_SURFACE/README.md, docs/ENVIRONMENTS.md, docs/EVENTS.md, docs/OBSERVABILITY.md, docs/RELEASE_CHANNELS/README.md, docs/RELEASE_CHANNELS/TERMINOLOGY.md, docs/runbooks/UAT_PANEL_WATCHER.md, app/api/routes/artifacts.py, app/api/routes/panel.py, app/chat/canvas_writer.py, app/chat/governance_router.py, app/chat/read_only_cognition.py, app/chat/session_log.py, app/chat/session_store.py, app/context_dimensions.py, app/domain/commitments.py, app/orientation/runtime.py, app/resurfacing/runtime.py, app/panel/confirmation.py, companion-ui/companion-app/companion_ui/workspace/real_note_workspace_shell.py, companion-ui/companion-app/companion_ui/workspace/confirm_session.py, companion-ui/companion-app/companion_ui/workspace/serve_dev_page.py, companion-ui/companion-app/companion_ui/renderer/vault_markdown_renderer.py, companion-ui/companion-app/companion_ui/renderer/mermaid_renderer.py, tests/api/test_artifact_note_read_api.py, tests/api/test_panel_confirm_api.py, tests/api/test_canvas_api.py, tests/chat/test_canvas_writer.py, tests/chat/test_governance_router.py, tests/chat/test_read_only_chat_cognition.py, tests/chat/test_session_log_writer.py, tests/cli/test_canvas_cli.py, tests/commitments/test_commitment_queries.py, tests/integration/test_panel_confirm_integration.py, tests/orientation/test_orientation_runtime.py, tests/resurfacing/test_resurfacing_runtime.py, merged PRs #1054/#1056/#1068/#1069/#1070/#1076/#1118/#1119, Companion UI dev/staging-shell merged PRs (Markdown/editor UAT #1430/#1432/#1433/#1434/#1429 and the #1335/#1395 design-review + adaptive-workspace umbrellas with hardening #1417/#1418/#1419/#1425/#1427), targeted panel/canvas verification (`PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 /opt/homebrew/opt/python@3.12/bin/python3.12 -m pytest tests/chat/ tests/api/test_canvas_api.py tests/api/test_artifact_note_read_api.py tests/api/test_panel_confirm_api.py tests/cli/test_canvas_cli.py tests/integration/test_panel_confirm_integration.py -m 'not pg' -q`), and current repo state at f15cec4d on 2026-05-30 (two pre-existing companion_ui baseline test failures remain — `companion.py:562` lambda `signals` kwarg and the drifted workspace-runtime-safety-strip testid — and are unrelated to this update)
