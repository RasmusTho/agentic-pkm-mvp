...
- Fitness: PASS — `python -m app.fitness.report` (latest sample: QAS-003 p95=0.000138 s, QAS-010 p95=0.000006 s).
...
## Metrics Snapshot
- QAS-003 p95: 0.000138 s
- QAS-010 p95: 0.000006 s
- Golden P@10 / nDCG@10: 0.20 / 0.97 (ce_local), baseline 0.20 / 0.97
- Relation coverage: 50% (golden sample)

### Latest CI Snapshot
CI SUMMARY LATENCY QAS003=0.000138s QAS010=0.000006s  
