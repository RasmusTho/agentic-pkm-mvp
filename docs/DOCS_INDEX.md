...
| docs/ROADMAP.md | Strategic roadmap | Aligned (SoT v5.5 baseline locked + forward line v5.6 planned) | 2026-03-27 | Forward line leans on the v5.5 baseline while v5.6 LangGraph/Reasoning stages are planned; capability-based architecture and agent evolution are now framed as phased sequencing rather than implementation backlog detail. |
...
| docs/plans/V60_CAPABILITY_AND_AGENT_EVOLUTION.md | v6.0 capability and agent evolution plan | Plan | 2026-03-27 | Working plan for capability-based composition, Panel/Chat separation, staged Deep Agent rollout, and governed execution; expands the roadmap without turning top-level docs into backlog surfaces. |
