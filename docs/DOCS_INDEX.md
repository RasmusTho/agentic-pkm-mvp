...
| docs/ENVIRONMENTS.md | Environment contract (`dev` vs `prod`) | Aligned (forward line v5.x) | 2026-03-31 | Canonical SoT for environment purpose, invariants, allowed variance, vault/store/runtime separation, and production safety expectations. |
