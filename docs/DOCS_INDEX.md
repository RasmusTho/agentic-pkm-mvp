...
| docs/DESIGN_PRINCIPLES.md | Stable system design principles | Aligned (SoT v5.5 baseline + v6 direction framing) | 2026-03-27 | Canonical owner of boundary-first design, interaction-first architecture, capability-based composition, explicit mutation authority, governance-before-autonomy, and documentation-layer responsibilities; read before changing architecture or roadmap framing. |
| docs/ROADMAP.md | Strategic roadmap | Aligned (SoT v5.5 baseline locked + forward line v5.6 planned) | 2026-03-27 | Forward line leans on the v5.5 baseline while v5.6 LangGraph/Reasoning stages are planned; capability-based architecture and agent evolution are framed as phased sequencing, with v5.6 treated primarily as an invariant layer rather than a rigid linear prerequisite chain. |
