...
| docs/runbooks/RUNBOOK_STARTUP_FULL_SYSTEM.md | Runbook: full-system startup | Aligned (forward line v5.x) | 2025-12-21 | Brings up db/api/worker/watcher via scripts/start_full_system.sh and interprets /api/health. |
| docs/runbooks/RUNBOOK_RUNTIME_GAP_TEST.md | Runbook: runtime gap test | Aligned (forward line v5.x) | 2025-12-21 | Verifies the watcher → worker → index → /api/ask flow via scripts/gap_test_alpha.sh. |
