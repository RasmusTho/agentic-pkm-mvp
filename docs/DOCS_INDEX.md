...
| docs/ARCHITECTURE.md | Architecture (SoT v5.x forward line on v5.5 base) | Aligned (forward line v5.x) | 2026-04-13 | Active runtime architecture source of truth; focused on the current runtime/data model, explicit about forward-line versus historical material, and now cross-checked against the completed salience-as-derived capability spec and current-state bug follow-up issues #435/#436/#437. |
...
| docs/STATUS.md | Operational snapshot | Aligned (SoT v5.5 baseline locked + forward line v5.6 planned) | 2026-04-13 | Current snapshot of runtime reality, verification status, and forward-line Now/Next/Later; includes the present-tense agent-evolution posture while keeping autonomous execution explicitly out of current truth, and now reflects PR #434 plus temporal-audit follow-up issues #435/#436/#437 for current-state domain/zone bugs. |
...
| docs/ROADMAP.md | Strategic roadmap | Aligned (SoT v5.5 baseline locked + forward line v5.6 planned) | 2026-04-13 | Forward line leans on the v5.5 baseline while v5.6 LangGraph/Reasoning stages are planned; capability-based architecture, bounded agent evolution, and governed mutation paths remain forward-looking after PR #431 and the partial sync-validation acceptance in PR #434. |
