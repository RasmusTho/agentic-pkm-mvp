...
| docs/CONCEPTS/TRUST_CONTRACT.md | Trust semantics contract (assert/suggest/apply) | Aligned (forward line v5.x) | 2025-12-16 | Defines trust tiers, gating rules, and receipt expectations; referenced by PROJECT_KERNEL. |
...
| docs/CONCEPTS/EVENT_COMPATIBILITY_CONTRACT.md | Event/intent compatibility contract (versioning) | Aligned (forward line v5.x) | 2025-12-16 | Defines envelope semantics, idempotence expectations, and backward/forward compatibility; canonical anchor for EVENTS. |
