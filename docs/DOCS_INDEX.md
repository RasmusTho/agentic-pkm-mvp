...
| docs/CONTEXT_BUNDLES/README.md | v6.x capability spec — context bundles | Draft specification (docs-only breakdown) | 2026-05-13 | Defines the implementation-ready breakdown for the context-bundle contract, including schema, retrieval emission, orientation/resurfacing usage, write-proposal linkage, and receipt recording, without claiming shipped runtime behavior. |
| docs/CONTEXT_BUNDLES/PARENT_FEATURE_ISSUE.md | Context bundles parent feature issue draft | Draft local parent issue source | 2026-05-13 | Local draft parent feature issue for later GitHub filing; defines scope, constraints, implementation tasks, verification path, and validation/acceptance path for context-bundle work. |
| docs/CONTEXT_BUNDLES/DEFINE_CONTEXT_BUNDLE_SCHEMA.md | Context bundles task spec — schema | Draft task specification | 2026-05-13 | Bounded implementation task for the minimal inspectable bundle schema and authority flags. |
| docs/CONTEXT_BUNDLES/EMIT_CONTEXT_BUNDLE_FROM_RETRIEVAL.md | Context bundles task spec — retrieval emission | Draft task specification | 2026-05-13 | Bounded implementation task for emitting context bundles from retrieval rather than exposing only ranked results. |
| docs/CONTEXT_BUNDLES/USE_CONTEXT_BUNDLE_FOR_ORIENTATION.md | Context bundles task spec — orientation usage | Draft task specification | 2026-05-13 | Bounded implementation task for consuming context bundles in orientation while preserving fact/inference/stale distinctions. |
| docs/CONTEXT_BUNDLES/USE_CONTEXT_BUNDLE_FOR_RESURFACING.md | Context bundles task spec — resurfacing usage | Draft task specification | 2026-05-13 | Bounded implementation task for consuming context bundles in resurfacing with explicit why-now provenance. |
| docs/CONTEXT_BUNDLES/CONNECT_CONTEXT_BUNDLE_TO_WRITE_PROPOSALS.md | Context bundles task spec — write proposal linkage | Draft task specification | 2026-05-13 | Bounded implementation task for carrying bundle evidence into governed write proposals without bypassing write guards. |
| docs/CONTEXT_BUNDLES/RECORD_CONTEXT_BUNDLE_RECEIPTS.md | Context bundles task spec — receipts | Draft task specification | 2026-05-13 | Bounded implementation task for recording bundle creation and usage receipts with provenance and exclusions. |
