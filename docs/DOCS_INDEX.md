...
| Path | Scope | Review status | Last reviewed | Notes |
| --- | --- | --- | --- | --- |
| docs/ARCHITECTURE.md | Architecture (SoT v5.x forward line on v4.10 base) | Aligned (forward line v5.x) | 2025-03-12 | Locked v4.10 baseline; forward line through v5.5 (PanelAgent planner/orchestration, watcher track, promotion consumer). |
...
| docs/ROADMAP.md | Strategic roadmap | Aligned (forward line v5.x + v5.5/v5.6 planned) | 2025-03-12 | Forward-looking only; history moved to docs/history/SOT_4X_HISTORY.md; tracks through v5.5B. |
| docs/history/SOT_4X_HISTORY.md | SoT 4.x history | Legacy (archived) | 2025-03-12 | Historical v4.x ladder moved from ROADMAP; forward plan now in ROADMAP. |
