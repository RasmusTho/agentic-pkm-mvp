...
- [ADR-0058: Event Horizon decay — relevance decay is a derived, reversible retrieval consequence of Episode closure (Accepted)](./ADR-0058-event-horizon-closure-decay.md)
...
- [ADR-0062: BuilderOps as an ecosystem-wide API-first enabling system (Accepted)](./ADR-0062-builderops-ecosystem-wide-enabling-system.md)
