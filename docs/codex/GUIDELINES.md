State: Dev-layer guidelines (historical). This file may lag the current architecture; prefer `AGENTS.md`, `docs/development/DEV_WORKFLOW.md`, and the repo tests/contracts.
