...
| EBF - External Boundary Fabric | External Boundary | Yes | Partial | Manual review now | Partial | Existing integration/tool/provider docs exist; source observation contract remains future work. |
