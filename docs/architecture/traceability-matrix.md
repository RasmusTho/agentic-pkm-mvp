...
ADR-0036–ADR-0039 record the optional standards and contract-semantics decisions. The ADR cells in
the matrix above point to the principle rows each one freezes; the new ADRs cross-reference the
related existing decisions (ADR-0015–ADR-0025) rather than re-deciding them.
