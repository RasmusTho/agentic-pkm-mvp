...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Similarity is not permission. | [cross-scope-flow](cross-scope-flow.md) | ADR-0028, ADR-0039 | `CrossScopeFlow`, `RetrievalResult`, `Relation` | `scope_binding` ≠ permission; `evidence_role` ≠ retrieve/cite right | RCA, GOV, WSP | [retrieval-contract](retrieval-contract.md) / [schema](../../schemas/retrieval-result.schema.json); [metadata-bundle](metadata-bundle.md) (#2544, #2548) | anti-contamination eval — TBD (#2551); xfail skeleton (#2552) | #2539, #2548, #2551 |
...
| 8 | Projection is not evidence. | [functional-ontology](functional-ontology.md), [semantic-dimensions](semantic-dimensions.md) | ADR-0018, ADR-0022, ADR-0033, ADR-0037 | `Projection`, `Segment` | `evidence_role` (default `non_evidence`), `authority_state` | DRI, OEF, GOV | [context-envelope](context-envelope.md) / [schema](../../schemas/context-envelope.schema.json) (#2545) | anti-contamination eval — TBD (#2551) | #2537, #2538, #2545 |
...
| 16 | Derived/rebuildable representations must preserve metadata and provenance. | [functional-ontology](functional-ontology.md), [semantic-dimensions](semantic-dimensions.md) | ADR-0018, ADR-0024, ADR-0038 | `Segment`, `Projection`, `Source` | `source_role`, `scope_binding`, `evidence_role` | DRI, SIP, PDM | [metadata-bundle](metadata-bundle.md) / [schema](../../schemas/metadata-bundle.schema.json) (#2544) | anti-contamination eval — TBD (#2551) | #2537, #2544 |
...
follow-up). Each principle row above links every ADR that freezes or sharpens it — the required
doctrine ADRs added to rows that previously listed only the earlier mechanism-level ADRs (row 4 →
ADR-0030, row 8 → ADR-0033, row 9 → ADR-0031, row 12 → ADR-0032, row 13 → ADR-0035) and the
follow-up ADRs threaded into the rows they name in their own *Affected invariants* (rows 7, 8 →
ADR-0037; rows 12, 16 → ADR-0038; rows 1, 7 → ADR-0039; ADR-0036 records doctrine §2.7, which has no
principle row). All new ADRs cross-reference the related existing decisions (ADR-0015–ADR-0025)
