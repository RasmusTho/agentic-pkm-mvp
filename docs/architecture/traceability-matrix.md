...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Similarity is not permission. | [cross-scope-flow](cross-scope-flow.md) | ADR-0028, ADR-0039 | `CrossScopeFlow`, `RetrievalResult`, `Relation` | `scope_binding` ≠ permission; `evidence_role` ≠ retrieve/cite right | RCA, GOV, WSP | [retrieval-contract](retrieval-contract.md) / [schema](../../schemas/retrieval-result.schema.json); [metadata-bundle](metadata-bundle.md) (#2544, #2548) | [invariant registry](../testing/invariant-tests.md) `similarity_not_permission`; runtime [test_cross_scope_flow](../../tests/invariants/test_cross_scope_flow.py); eval [corpus](../../tests/evals/fixtures/README.md) (#2550, #2551, #2552) | #2539, #2548, #2551 |
...
| 6 | Typed `CrossScopeFlow` replaces any global `general_knowledge` bypass. | [cross-scope-flow](cross-scope-flow.md) | ADR-0028 | `CrossScopeFlow`, `Scope` | `source_role` (`general_knowledge` = eligibility, not bypass), `scope_binding` | GOV, RCA | [metadata-bundle](metadata-bundle.md) / [retrieval-result schema](../../schemas/retrieval-result.schema.json) (#2544, #2548) | [invariant registry](../testing/invariant-tests.md) `cross_scope_only_via_flow`; runtime [test_cross_scope_flow](../../tests/invariants/test_cross_scope_flow.py), [test_general_knowledge_crosses_clean](../../tests/evals/test_general_knowledge_crosses_clean.py) (#2550, #2551, #2552) | #2539, #2551 |
| 7 | Retrieval produces candidate evidence, not truth. | [cross-scope-flow](cross-scope-flow.md), [semantic-dimensions](semantic-dimensions.md) | ADR-0024, ADR-0037, ADR-0039 | `RetrievalResult`, `Projection`, `Segment` | `evidence_role`, `authority_state` | [RCA](../boundaries/RCA.md), [GOV](../boundaries/GOV.md), [SIP](../boundaries/SIP.md) | [retrieval-contract](retrieval-contract.md) / [schema](../../schemas/retrieval-result.schema.json); [Retrieval implementation](../../app/retrieval/capability.py) (#2548) | [invariant registry](../testing/invariant-tests.md) `retrieval_candidate_identity_single_source`, `retrieve_scope_prefilter`; [test_retrieval_result](../../tests/invariants/test_retrieval_result.py) (#2550, #2552) | #2548, #2550 |
