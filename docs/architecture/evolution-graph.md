...
graph TD
  ...
  subgraph Platform["Platform / ecosystem"]
    ...
    SOS[SoS reconciliation: #2888 closed unmerged; #2890 closed; #2891 glossary<br/>next]
...
| SoS reconciliation (#2888 closed unmerged; #2890 closed; #2891 glossary per ADR-0043 §6) | next | L | M | M | L | L | Remaining glossary work; the ADR reconciliation has landed |
