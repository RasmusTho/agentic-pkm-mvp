...
| 4 | Continuous discovery: subscription/playlist sync, scheduling, dedup at scale | specification filed: `docs/YOUTUBE_SOURCE_SYNC/` (YSS-01..YSS-11 — OAuth `youtube.readonly` inbox/playlist discovery + Takeout/RSS subscriptions per the 2026-07-16 owner directive; `YOUTUBE_SOURCE_SPEC.md` §Discovery carries the revision); implementation not yet delivered |
