...
2. [REWRITTEN_NOTE_CONFLICT_STAGING](REWRITTEN_NOTE_CONFLICT_STAGING.md) (VMW-02), after VMW-01
3. [ICLOUD_CONFLICT_QUARANTINE](ICLOUD_CONFLICT_QUARANTINE.md) (VMW-03), independent of VMW-01/02
...
- [ ] iCloud conflicted-copy names are excluded before ordinary ingestion. Verify: VMW-03 fixture test.
