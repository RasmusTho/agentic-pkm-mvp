...
6. **[LIFE_WIDE_ARTIFACT_TAXONOMY.md](LIFE_WIDE_ARTIFACT_TAXONOMY.md)** — Life-wide artifact taxonomy. Names the concrete artifact classes a life-wide PKM is expected to handle (ephemeral, operational, project, source, media, email, YouTube, contact, decision, reflection, evergreen, synthesis, companion, AI-suggestion, machine-mirror), and the conceptual separation between physical storage, human navigation, semantic artifact class, lifecycle, provenance, authority, and work relation. Docs-only; not a runtime contract.
