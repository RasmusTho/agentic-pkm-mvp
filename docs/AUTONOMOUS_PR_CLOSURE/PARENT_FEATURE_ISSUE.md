...
| --- | --- | --- | --- |
| AVC-01 — verification execution authority | [#3603](https://github.com/RasmusTho/agentic-pkm-mvp/issues/3603) | `agent:needs-human`; API-backed installed-main Demerzel verification authority/pilot | BuilderOps control-plane BCP-02 and BCP-04 acceptance |
| AVC-02 — post-merge closure and orphan recovery | [#3604](https://github.com/RasmusTho/agentic-pkm-mvp/issues/3604) | `agent:blocked`; exclusive closure dispatch/reconciliation owner | AVC-01 / #3603 |

## Validation handoff

After AVC-01 and AVC-02 each receive their existing PR/Issue closure receipts, record the pilot's
