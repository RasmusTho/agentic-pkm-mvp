...
prerequisites: [MVR-01, MVR-02, MVR-03, MVR-04, MVR-05, MVR-06, MVR-07A, MVR-07B]
...
- Before authoring shipped owner truth, route MVR-07B's exact merged `origin/main` SHA through the
...
- In the MVR-08 PR, change README to shipped capability truth and convert the parent reference from a
  ...
  MVR-01A–01C, MVR-02–04, MVR-05A–05D, MVR-06A–06D, and MVR-07A–07B receipts plus the MVR-08 PR/head candidate, but explicitly delegates MVR-08's eventual
...
- [ ] Before any shipped-truth owner-doc edit is authored, MVR-07B's exact merged `origin/main` SHA has
  ...
  unchanged.
  - Verify: durable test-channel promotion receipt for the exact MVR-07B merge SHA + runtime receipt
...
- [ ] Architecture/context/topology/settings/environment owner docs and transition debt match
  ...
  successful durable test-channel promotion and redacted smoke receipt for MVR-07B's exact merged SHA.
...
- [ ] This capability's own lifecycle surfaces no longer claim future/blocked runtime state: README
  ...
  MVR-02–04, MVR-05A–05D, MVR-06A–06D, and MVR-07A–07B receipts,
...
- Before authoring owner-doc/debt promotion, fetch MVR-07B's merged `origin/main`, create a clean
...
- Route that same exact MVR-07B merged SHA through the governed
  ...
  the exact MVR-07B SHA before any shipped-truth owner-doc edit is authored or merged. Failure leaves
  MVR-08 unstarted/blocked and current-state owner docs unchanged.
- In that MVR-07B merged-head worktree run:
...
- Do not require a live pinned-image promotion of the unmerged MVR-08 PR head: the required
  pre-authoring live proof targets MVR-07B's already-merged, publishable SHA. On the PR head, verify the candidate image
...
- Against a disposable local/CI runtime using two isolated fixture bindings declared in the redacted
  ...
  The MVR-07A compatibility slice owns this harness and its production-path/root-safety tests. Before
...
MVR-05A–05D, MVR-06A–06D, and MVR-07A–07B merge. Use Terra/high for
