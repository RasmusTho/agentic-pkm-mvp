...
- **Later**
  ...
  - Context bundle and agent-memory contracts now have docs-first implementation breakdowns at `docs/CONTEXT_BUNDLES/` and `docs/AGENT_MEMORY/`; filing parent feature issues and child implementation issues from those specs is the next execution step, not shipped runtime work.
