...
- **Post-v5.6 follow-ups**
  ...
  - Orchestrator V2 timeout retry discriminator cleanup: #456 tracks the mismatch between documented executor `tool_timeout` errors and the V2 non-retry discriminator.
