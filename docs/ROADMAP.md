...
- **Now**
  ...
  - **Integrated Runtime v1 release line (#1874)** — closed/completed 2026-06-12; delivered route parity, readiness matrix, Panel staging persistence, golden-path UAT, negative-safety UAT, and docs reduction.
