...
- **Later**
  ...
  - Release-channels capability is now specified under `docs/RELEASE_CHANNELS/README.md`; promotion
    and rollback operator skills are authored, but stable-channel validation and feature acceptance
    remain pending on feature #609 before roadmap text can treat the channel model as operationally
    accepted.
