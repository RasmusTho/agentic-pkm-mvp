...
writer until the first connection has released it; cancellation synchronizes with an in-progress
poll/bind so it cannot release the admission mid-transition.
