State: Target-state capability specification, created 2026-09-22 from accepted ADR-0066 and amended 2026-09-23 for the selected Tailscale-only macOS executor. MARR-01, MARR-02, and the base MARR-08 completion API are merged. MARR-04 catalog discovery is implemented in open PR #5651 and remains unshipped until merge; Product/Builder caller migration, the MARR-03 preflight extension and fallback policy, designated-host profile, and rollout remain unshipped. Parent validation Issue #5618 is open and blocked.
