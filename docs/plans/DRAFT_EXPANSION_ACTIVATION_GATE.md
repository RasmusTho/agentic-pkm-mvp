State: DRAFT for human review — NOT an active plan, NOT a backlog-wave source. Wired into `docs/DOCS_INDEX.md` as an indexed draft proposal. Produced 2026-06-15 from the Cognitive Maintenance vs Expansion audit. Tracked by parent #2022: slices #2023 (admissibility contract) and #2024 (gate contract) are authored and shipped; #2026 (ASK synthesis activation) has passed TEST verification. It proposes how the pre-positioned Cognitive Expansion surfaces become live without bypassing governance. This doc itself does **not** flip any flag or supersede `docs/plans/MAJOR_ROADMAP_RESET_2026_06_04.md`. Adopt, rewrite, or discard after the one-vertical-loop proof lands.
