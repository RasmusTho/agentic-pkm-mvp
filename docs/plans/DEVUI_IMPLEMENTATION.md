...
| M2 — first-repository owner loop | The owner directs one real feature delivery and judges its result | #5531 defines the [first approved Issue-delivery operation](../BUILDER_FACTORY_ACCEPTANCE/README.md#first-approved-issue-delivery-operation); #5550 delivers caller-bound admission with a commit-shaped source, one-Issue frozen dispatch-plan hash, and closed execution/verification profile; #5551 delivers FCA-ID-B destination reservation/launch and protected effect gates. FCA-ID-C independent result readback, separate live activation/deployment, actual candidate trial and explicit accept/reject remain required; [FCA milestone](../BUILDER_FACTORY_ACCEPTANCE/README.md#first-repository-milestone) |
