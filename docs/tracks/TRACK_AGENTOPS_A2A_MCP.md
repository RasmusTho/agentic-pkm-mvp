...
- A2A contracts: current-state envelope schema and emitted audit actions are documented in `docs/contracts/A2A_CONTRACT_AND_TRACE.md`; orchestration-managed routing remains planned. Tracked by: #233
