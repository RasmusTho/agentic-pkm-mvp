State: v5.5B delivered (planner pipeline + CLI-first orchestration + promotion consumer); LangGraph decider + watcher auto-exec planned.
...
- LangGraph-driven decider as default once proven; watcher auto-exec path for panel plans with safety limits.
