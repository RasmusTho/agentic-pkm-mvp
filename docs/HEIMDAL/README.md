...
| **⇢ owner boundary** | [EXTERNAL_SYSTEMS_CONTROL_PLANE.md](EXTERNAL_SYSTEMS_CONTROL_PLANE.md) | **Accepted target-state ownership boundary** (2026-09-12): Heimdal owns the external helper-system catalog, provider identities, channels, credential references, adapters, runbooks, and lifecycle; Builder Vault is the canonical operational record. No separate control-plane implementation is claimed. |
