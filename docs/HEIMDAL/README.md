...
| **⇢ owner boundary** | [EXTERNAL_SYSTEMS_CONTROL_PLANE.md](EXTERNAL_SYSTEMS_CONTROL_PLANE.md) | **Accepted target-state ownership boundary** (2026-09-12): Heimdal owns the external helper-system catalog, provider identities, channels, credential references, adapters, runbooks, and lifecycle; Builder Vault is the intended single operational record once an authority-capable surface is accepted. No separate control-plane implementation is claimed. |
