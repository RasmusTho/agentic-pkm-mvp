...
- [x] Cold start (>7d cold trajectory; vault bound) and `no_vault` (runtime unreachable or no vault bound — including the first-contact picker) render no re-entry overlay.
