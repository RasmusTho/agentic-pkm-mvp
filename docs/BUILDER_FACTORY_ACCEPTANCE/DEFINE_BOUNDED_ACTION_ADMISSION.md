...
Parent validation: #5399. Existing related work: #4169, #4697, #5404. FCA-08 is a stable specification ID, not a filed Issue. Write `github_issue` frontmatter only after successful filing and readback. Milestone: M0.
