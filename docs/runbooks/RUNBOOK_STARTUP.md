...
7. Guard Obsidian abstraction boundaries with the architecture contract test: `PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 pytest -q tests/architecture/test_obsidian_port_boundaries.py -m "not pg"`.
