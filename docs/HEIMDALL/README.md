...
| **→** | [FABLE_COMPANION.md](FABLE_COMPANION.md) | **The Fable window's design output** (2026-07-05): the proposed design for all 8 OPEN problems, anchored in the voice-memo v1 vertical, plus an adversarial red-team pass and owner decisions a–i — *the design that unlocks the build* |
