...
# Vault root for this self-verifying harness. Use only test-channel selectors as
# inputs; plain VAULT_ROOT may point at the operator/prod vault. The repo-local
# scratch vault is a throwaway CI/local fixture, never a real vault.
BOOTSTRAP_VAULT_ROOT="${VAULT_ROOT_TEST:-${TEST_VAULT_ROOT:-${ROOT}/vault-test}}"
